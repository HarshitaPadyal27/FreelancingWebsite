...
<body style="background-color: Cornsilk;">
	<!-- <body style="background-image: url('st_img/home.jpg');"> -->
	<!-- ======= Header ======= -->
	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			...
			<div class="col-md-8" data-aos-delay="100">
				<div class="icon-box">
					<h2 align="center" style="color: red;">User Create Account</h2>
					<form action="UserRegistration" method="POST">
						<table class="table table-bordered">
							...
							<tr>
								<td>Mobile Number</td>
								<td><input type="text" placeholder="Mobile Number" name="mobile" required="required"></td>
							</tr>
							
							<tr>
								<td>User Types</td>
								<td><input type="radio" name="user_type" value="Work">&nbsp;I Want to Work&nbsp;</td><td><input type="radio" name="user_type" value="Hire">&nbsp;I Want to Hire&nbsp;</td>
							</tr>
							
							<tr>
								<td>Email ID</td>
								<td><input type="text" name="email" placeholder="Email ID" required="required"></td>
							</tr>
							<tr>
								<td>Password</td>
							...
							<tr>
								<td></td>
								<td><button type="submit" class="btn btn-success">Registration</button>
								</td>
							</tr>
							<tr>
								<td></td>
								<td><a href="userLogin.jsp">Already Account Click Here</a></td>
							</tr>
						</table>
					</form>
				</div>
