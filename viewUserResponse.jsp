	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				PreparedStatement ps=con.prepareStatement("SELECT * FROM `bidding_details` where user_id='"+email+"'");
				...
				while(rs.next())
				{
					...
					HashMap<String,String> req_details =gf.getRequirmentDetails(id, email);
				
				%>
				<tr>
					<td><%=i %></td>
					<td><%=req_details.get("requirment") %></td>
					<td><%=req_details.get("technology") %></td>
					<td><%=req_details.get("days") %></td>
					<td><%=bid_count %></td>
