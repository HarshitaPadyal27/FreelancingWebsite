	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			...
			<div class="col-md-10" data-aos-delay="100">
				<div class="icon-box">
					<h2 align="center" style="color: red;">View Request Status</h2>
			...
			<div class="col-md-12">
				...
				PreparedStatement ps=con.prepareStatement("SELECT * FROM `bidding_details` where req_id='"+rr_id+"'");
				...
				while(rs.next())
				{
					...
					int bid_count=gf.getCount(request, id);
					HashMap<String,String> user_details=gf.getUserProfile(rs.getString("user_id"));
				...
				<tr>
					...
					<td><%=user_details.get("mobile_number") %></td>
					<td><%=user_details.get("email") %></td>
					<td><%=user_details.get("acc_c_date") %></td>
					<td><%=rs.getString("amount_details") %></td>
					<td><%=rs.getString("c_date") %></td>
					<td><%=rs.getString("status") %></td>
					<td><a href="SendResponse?id=<%=b_id%>">Send Approved</a></td>
				</tr>
				<% } %>
			</table>
