	...
	<div class="container" data-aos="fade-up">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				String req_by=session.getAttribute("email").toString();
				Connection con=DbConnection.getConnection();
				PreparedStatement ps=con.prepareStatement("SELECT * FROM `requirment_details` where req_by='"+req_by+"' ORDER BY id DESC");
				...
				<tr>
					...
					<td><%=result %></td>
					<td><a href="viewUserRequest.jsp?id=<%=id%>">View Details</a></td>
				</tr>
				<% } %>
			</table>
